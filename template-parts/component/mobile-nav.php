<nav class="c-mobileNav" id="mobileNav">
    <div class="c-mobileNav__header">
        <a href="/" class="c-mobileNav__logo" aria-label="TOPへ戻る">
            <svg
                class="c-mobileNav__logo-icon"
                version="1.0"
        ...
        <button
            class="c-mobileNav__closeButton"
            aria-label="メニューを閉じる"
            type="button"
        >
            <span class="c-mobileNav__closeButton-line"></span>
            <span class="c-mobileNav__closeButton-line"></span>
        </button>
    </div>
    <div class="l-container c-mobileNav__container">
        <ul class="c-mobileNav__list">
            <li class="c-mobileNav__list-item">
                <a href="/" class="c-mobileNav__link">
                    <div class="c-mobileNav__list-item-text">
                        <div class="c-mobileNav__list-item-text-en">TOP</div>
                        <div class="c-mobileNav__list-item-text-ja">トップページ</div>
                    </div>
                </a>
            </li>
            <li class="c-mobileNav__list-item">
                <a href="/" class="c-mobileNav__link">
                    <div class="c-mobileNav__list-item-text">
                        <div class="c-mobileNav__list-item-text-en">LESSONS</div>
                        <div class="c-mobileNav__list-item-text-ja">ウチマナベの教室</div>
                    </div>
                </a>
                <ul class="c-mobileNav__subList">
                    <li class="c-mobileNav__subList-item">
                        <a href="" class="c-mobileNav__subList-link">油絵教室</a>
                    </li>
                    <li class="c-mobileNav__subList-item">
                        <a href="" class="c-mobileNav__subList-link">水彩教室</a>
                    </li>
                    <li class="c-mobileNav__subList-item">
                        <a href="" class="c-mobileNav__subList-link">AAAA教室</a>
                    </li>
                    <li class="c-mobileNav__subList-item">
                        <a href="" class="c-mobileNav__subList-link">AAAA教室</a>
                    </li>
            ...
            <li class="c-mobileNav__list-item">
                <a href="/" class="c-mobileNav__link">
                    <div class="c-mobileNav__list-item-text">
                        <div class="c-mobileNav__list-item-text-en">JOIN</div>
                        <div class="c-mobileNav__list-item-text-ja">入会をお考えの方へ</div>
                    </div>
                </a>
            </li>
            <li class="c-mobileNav__list-item">
                <a href="/" class="c-mobileNav__link">
                    <div class="c-mobileNav__list-item-text">
                        <div class="c-mobileNav__list-item-text-en">Map</div>
                        <div class="c-mobileNav__list-item-text-ja">教室の場所</div>
                    </div>
                </a>
            </li>
        </ul>
        <div class="c-mobileNav__orientation">
            <a href="" class="c-link__cv">体験レッスン</a>
        </div>
    </div>
</nav>